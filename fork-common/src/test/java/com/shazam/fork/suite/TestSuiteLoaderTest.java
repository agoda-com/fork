...
public class TestSuiteLoaderTest {
    ...
    public void setUp() throws Exception {
        testSuiteLoader = new TestSuiteLoader(ANY_INSTRUMENTATION_APK_FILE, fakeDexFileExtractor, fakeTestClassMatcher, "", "", new TestCaseEventFactory(new TestStatsLoader(new StatServiceLoader(""))));
    }
